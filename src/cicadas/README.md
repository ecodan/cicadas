...
- `scripts/`: CLI tools for project lifecycle operations (kickoff, branch, status, create_lifecycle, open_pr, review, tokens, validate_skill, skill_publish, unarchive, etc.).
