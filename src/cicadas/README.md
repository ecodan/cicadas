...
- **UX**: Map the interaction and UI for product work, or capture CLI/log/error/docs/agent-facing behavior in `operator-experience.md` for technical/operator-facing work.
